...
public class ProdSecurityDBUsernamePwdAuthenticationProvider implements AuthenticationProvider {
    ...
    public @Nullable Authentication authenticate(@Nullable Authentication authentication) throws AuthenticationException {
        ...
        if(passwordEncoder.matches(password,userDetails.getPassword())){
            /*Any kind of custom validation we can write over here like
            1. Age of user > 18
            2. Geographical location of user
            Based upon that we can decide further.
            */
